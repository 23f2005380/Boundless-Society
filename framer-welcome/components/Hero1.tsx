    ...
    return (
        ...
        <div className="text-center mb-8">
          ...
          <div className="p-3 md:p-4 rounded-lg max-w-xs md:max-w-2xl mx-auto mb-6 md:mb-8">
            ...
            <button className="bg-[#FFE878] hover:translate-y-5 text-[#3B001B] px-6 md:px-8 py-2 rounded-full font-semibold text-sm md:text-base" style={{boxShadow : "0px 5px 1px #9c1352"}}>
              Join Us
            </button>
